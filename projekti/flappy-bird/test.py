...
class Ball:
    ...
    def bounce(self):
        self.vx = -self.vx + random.gauss(0, 2)
        self.vy = -self.vy + random.gauss(0, 2)
...
while running:
    ...
    COUNTER_surface = font.render("Score: "+str(COUNTER),True, (255,255,255))
    screen.blit(COUNTER_surface,(10,SCREEN_HEIGHT-40))
    pygame.display.flip()
    clock.tick(60)
pygame.quit()